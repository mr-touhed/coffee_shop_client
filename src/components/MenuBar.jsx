...
const MenuBar = () => {
  ...
  const MenuItems = (
    <>
      ...
      <li>
        <Link to="/spacial">Spacial Offer</Link>
      </li>
      {user && (
        <li>
      ...
      <section className="navbar text-gray-200">
        <div className="navbar-start">
          <div className="dropdown">
            ...
            <ul
              tabIndex={0}
              className="menu menu-sm dropdown-content mt-3 z-[1] p-2 text-gray-700 shadow bg-base-100 rounded-box w-52"
            >
              {MenuItems}
            </ul>
          </div>
        ...
        <div className="navbar-end">
          {user ? (
            <Profile signOut={signOut} img={user?.photoURL} />
          ) : (
